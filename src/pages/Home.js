...
const Home = () => {
  ...
  <div className="project-list">
    ...
    <div className="project">
      <img src="https://via.placeholder.com/250x150?text=Vinopairings" alt="VinoPairings" />
      <h3>VinoPairings</h3>
    ...
    <div className="project">
      <img src="https://via.placeholder.com/250x150?text=CosmicZodiacAstrology" alt="Cosmic Zodiac Astrology" />
    ...
    <div className="project">
      <img src="https://via.placeholder.com/250x150?text=PsychologicalManipulation" alt="Psychological Manipulation" />
    ...
    <div className="project">
      <img src="https://via.placeholder.com/250x150?text=BigPaceBarbershop" alt="Big Pace Barbershop and Beauty Salon" />
      <h3>Big Pace Barbershop and Beauty Salon</h3>
      <p>A site for a local barbershop and beauty salon.</p>
      <a href="https://bigpacebarbershopandbeautysalon.com" target="_blank" rel="noopener noreferrer" className="project-link">Visit Site</a>
    </div>

    {/* Project 5 - Pinkerton Williams */}
    <div className="project">
      <img src="https://via.placeholder.com/250x150?text=PinkertonWilliams" alt="Pinkerton Williams" />
